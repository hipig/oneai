<template>
    <div class="px-2 space-y-6">
        ...
        <button @click="handleClear" type="button" class="w-full inline-flex justify-center items-center space-x-2 border border-red-700 font-semibold rounded-xl px-3 py-2 text-sm bg-red-50 text-red-700">
