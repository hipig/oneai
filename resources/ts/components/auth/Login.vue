        ...
        <Dialog as="div" class="relative z-10">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                    <DialogPanel class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg">
                        ...
                        <div class="px-8 py-6">
                            <form action="#" class="space-y-6">
                                <div class="space-y-1">
                                    ...
                                    <div>
                                        <input type="text" v-model="loginForm.username" class="w-full px-4 py-2.5 bg-gray-100 border-gray-100 focus:border-gray-900 focus:ring-gray-900 rounded-xl"  placeholder="请输入用户名">
                                    </div>
                                </div>
                                <div class="space-y-1">
